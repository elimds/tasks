			...
			<ol class="property-list task">
				...
				<li class="fieldcontain">
					<span id="categoria-label" class="property-label"><g:message code="task.categoria.label" default="Categoria" /></span>
						...
						<span class="property-value" aria-labelledby="categoria-label"><g:link controller="categoria" action="show" id="${taskInstance?.categoria?.id}">${taskInstance?.categoria?.encodeAsHTML()}</g:link></span>
				...
				<g:if test="${taskInstance?.idTask}">
				<li class="fieldcontain">
					<span id="idTask-label" class="property-label"><g:message code="task.idTask.label" default="Id Task" /></span>
					
						<span class="property-value" aria-labelledby="idTask-label"><g:fieldValue bean="${taskInstance}" field="idTask"/></span>
